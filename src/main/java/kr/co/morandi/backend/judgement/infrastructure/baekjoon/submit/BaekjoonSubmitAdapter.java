...
public class BaekjoonSubmitAdapter {
    ...
    */
    public String submitAndGetSolutionId(String baekjoonProblemId, String cookie, Language language, String sourceCode, String submitVisibility) {
        ...
        final String languageCode = BaekjoonSubmitLanguageCode.getLanguageCode(language);
        final String submitVisibilityCode = BaekjoonSubmitVisibility.getSubmitVisibilityCode(submitVisibility);
        ...
        final String resultHtml = webClient.post()
                .uri(String.format(BaekjoonSubmitConstants.BAEKJOON_SUBMIT_URL, baekjoonProblemId))
                .header(USER_AGENT, BaekjoonSubmitConstants.BAEKJOON_USER_AGENT)
        ...
        * */
        if (initialResponse.statusCode().is3xxRedirection()) {
            ...
            if (!location.startsWith("http")) {
                location = URI.create(String.format(BaekjoonSubmitConstants.BAEKJOON_SUBMIT_URL, baekjoonProblemId))
                        .resolve(location)
                        .toString();
            }
