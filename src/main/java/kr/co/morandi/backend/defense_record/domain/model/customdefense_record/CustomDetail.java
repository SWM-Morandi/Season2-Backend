...
public class CustomDetail extends Detail {
    ...
    @Builder
    private CustomDetail(Member member, Long sequenceNumber, Problem problem, Record<? extends Detail> records, Defense defense) {
        super(member, problem, records, defense);
        this.problemNumber = sequenceNumber;
        this.solvedTime = INITIAL_SOLVED_TIME;
    }
    public static CustomDetail create(Member member, Long sequenceNumber, Problem problem, Record<? extends Detail> records, Defense defense) {
